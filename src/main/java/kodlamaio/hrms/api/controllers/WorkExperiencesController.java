...
public DataResult<List<WorkExperiences>> getAll(){
	return this.workExperiencesService.getAll();
}
@PostMapping("/add")
public Result add(@RequestBody WorkExperiences workExperiences) {
	return this.workExperiencesService.add(workExperiences);
}
